...

{
  ...
  if( TRUE %in% is.na(match(chrom,chr.sizes$chr))){
    ...
    if (paired)
    {
      ...
      system(paste0("samtools view -b -f 128 -F 16 -@ 4 ",bamfile," > a.F2.bam"))
      system(paste0("samtools view -b -f 80 -@ 4 ",bamfile," > a.R2.bam"))
      # combine the temporary files
      system(paste0("samtools merge -f ",fileOut,"_fwd.bam a.F2.bam a.R2.bam"))
